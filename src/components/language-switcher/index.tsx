      ...
      <div className="flex items-center space-x-4">
        <Popover open={open} onOpenChange={setOpen}>
          <PopoverTrigger asChild>
            <Button
              variant="outline"
              className="group w-[150px] justify-between rounded-lg border border-gray-300 bg-gray-50 px-3 py-2 pr-8 text-gray-900 transition-all duration-200 hover:text-orange-500 focus:border-transparent dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:hover:text-orange-400"
            >
